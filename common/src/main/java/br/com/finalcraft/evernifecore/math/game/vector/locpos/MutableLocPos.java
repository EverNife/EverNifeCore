...
public class MutableLocPos extends MutableVec3d<MutableLocPos> {
    ...
    public MutableLocPos(double x, double y, double z) {
        super(x, y, z);
    }

    @Override
    public MutableLocPos at(double x, double y, double z) {
        this.x = x;
        this.y = y;
        this.z = z;
        this.hash = 0;
    ...
    public static MutableLocPos from(IVec3i<?> vec3i) {
        return of(vec3i.getX(), vec3i.getY(), vec3i.getZ());
    }

    public static MutableLocPos from(IVec3d<?> vec3d) {
    ...
    public GameVecPlatformAdapterConverter.AdaptLocPos getAdapter(){
    ...
    public static MutableLocPos deserialize(String string) {
