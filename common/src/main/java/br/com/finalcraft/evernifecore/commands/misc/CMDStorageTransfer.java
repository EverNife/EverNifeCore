...
/**
 * Admin command that migrates a single PDSection's collection to another storage backend at
 ...
 * choice into storage.yml. A maintenance window is recommended.
 *
 * <pre>/ecorestoragetransfer &lt;plugin:section&gt; &lt;backend&gt;</pre>
 */
public class CMDStorageTransfer {
    ...
    @FinalCMD(
            aliases = {"ecorestoragetransfer", "ecstoragetransfer"},
