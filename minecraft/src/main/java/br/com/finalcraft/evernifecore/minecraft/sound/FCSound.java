...
public class FCSound {
    ...
    public static FCSound PLING = FCSound.of(FCSoundUtil.pickByEra(MCVersion.getCurrent(), "note.pling", "block.note.pling", "block.note_block.pling"));
    public static FCSound HARP = FCSound.of(FCSoundUtil.pickByEra(MCVersion.getCurrent(), "note.harp", "block.note.harp", "block.note_block.harp"));
    ...
    public static FCSound FIREWORK_BLAST = FCSound.of(FCSoundUtil.pickByEra(MCVersion.getCurrent(), "fireworks.blast", "entity.firework.blast", "entity.firework_rocket.blast"));
    public static FCSound FIREWORK_LARGE_BLAST = FCSound.of(FCSoundUtil.pickByEra(MCVersion.getCurrent(), "fireworks.largeBlast", "entity.firework.large_blast", "entity.firework_rocket.large_blast"));
    public static FCSound FIREWORK_BLAST2 = FCSound.of(FCSoundUtil.pickByEra(MCVersion.getCurrent(), "fireworks.blast2", "entity.firework.blast_far", "entity.firework_rocket.blast_far"));
    public static FCSound FIREWORK_TWINKLE = FCSound.of(FCSoundUtil.pickByEra(MCVersion.getCurrent(), "fireworks.twinkle", "entity.firework.twinkle", "entity.firework_rocket.twinkle"));
    public static FCSound FIREWORK_TWINKLE2 = FCSound.of(FCSoundUtil.pickByEra(MCVersion.getCurrent(), "fireworks.twinkle2", "entity.firework.twinkle_far", "entity.firework_rocket.twinkle_far"));
    public static FCSound FIREWORK_LAUNCH = FCSound.of(FCSoundUtil.pickByEra(MCVersion.getCurrent(), "fireworks.launch", "entity.firework.launch", "entity.firework_rocket.launch"));
    ...
    public static FCSound ENDERMAN_TELEPORT = FCSound.of(FCSoundUtil.pickByEra(MCVersion.getCurrent(), "mob.endermen.portal", "entity.endermen.teleport", "entity.enderman.teleport"));
