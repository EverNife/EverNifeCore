package br.com.finalcraft.evernifecore.minecraft.compat.v1_7_R4.worldedit.wrappers.clipboard.format;
...
import br.com.finalcraft.evernifecore.minecraft.worldedit.clipboard.format.IFCClipboardFormat;
...
public class IFCClipboardFormat_Schematic extends IFCClipboardFormat {
    ...
    public void getWriterAndWrite(OutputStream outputStream, Clipboard clipboard, Closer closer) throws IOException {
        ClipboardWriter writer = closer.register(ClipboardFormat.SCHEMATIC.getWriter(outputStream));
