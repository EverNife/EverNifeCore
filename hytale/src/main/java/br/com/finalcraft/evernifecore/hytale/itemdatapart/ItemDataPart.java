package br.com.finalcraft.evernifecore.hytale.itemdatapart;

import br.com.finalcraft.evernifecore.EverNifeCore;
import br.com.finalcraft.evernifecore.hytale.itemdatapart.datapart.*;
...
public abstract class ItemDataPart {
    ...
    public static ItemDataPart MAX_DURABILITY   = registerType(new ItemDataPartMaxDurability());
    ...
    public static ItemStack transformItem(List<String> itemData) {
        return transformItem(ItemStack.EMPTY, itemData);
    }
    ...
    public static boolean isSimilar(ItemStack base_item, ItemStack other_item, ItemDataPart[] exceptions, boolean compare_amount) {
        ...
        for (ItemDataPart part : ALL_REGISTERED_TYPES) {
            ...
            if (!compare_amount && part == QUANTITY) {
                continue;
            }
            try {
