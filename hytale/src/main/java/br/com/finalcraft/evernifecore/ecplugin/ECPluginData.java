...
public class ECPluginData {
    ...
    public ECPluginData(JavaPlugin plugin) {
        this.plugin = plugin;
        ...
        if (ecPlugin != null && ecPlugin.debugModuleEnum() != IDebugModule.class){
            if (!ecPlugin.debugModuleEnum().isEnum()){
                plugin.getLogger().at(Level.WARNING).log("Failed to read debugModuleEnum from @ECPlugin, " + ecPlugin.debugModuleEnum().getName() + " is not an enum!");
            }else {
        ...
        if (reloadMethod != null){
            ...
            this.onReload = () -> {
                try {
                    ...
                    plugin.getLogger().at(Level.WARNING).log("Failed to execute OnReload method of (" + plugin.getName() + ")");
                    e.printStackTrace();
                }
            };
